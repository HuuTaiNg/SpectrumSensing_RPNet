...
class RPNet(nn.Module):
    def __init__(self, n_classes):
        ...
        self.conv_layer1_3 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        
        # ===================  Stage 1  ===================
        self.conv_layer2_1 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer2_2 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer2_3 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer2_4 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer2_5 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        
        # ===================  Stage 2  ===================
        self.conv_layer3_1 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer3_2 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer3_3 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer3_4 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer3_5 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer3_6 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer3_7 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer3_8 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        
        # ===================  Stage 3  ===================
        self.conv_layer4_1 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer4_2 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer4_3 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer4_4 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer4_5 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer4_6 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer4_7 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer4_8 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer4_9 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer4_10 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer4_11 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        
        # ===================  Stage 4  ===================
        self.conv_layer5_1 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer5_2 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer5_3 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer5_4 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer5_5 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer5_6 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer5_7 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv_layer5_8 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        
        # ===================  Upsampling  ===================
        self.conv_layer6 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
...
def train_epoch(model, dataloader, criterion, optimizer, device, num_classes):
    ...
    cm = confmat.compute().cpu().numpy()  # Chuyển về numpy để sử dụng dễ dàng
